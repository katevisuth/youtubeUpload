...
(function() {
  ...
  function uploadVideoId(videoId, title){
    var ajax = $.post('/upload_video_id', {videoId: videoId});

    ajax.done(function(){
      alert('uploaded video id to database');
    });

    ajax.fail(function(){
      alert('failed to upload video id to database');
    })
  }
